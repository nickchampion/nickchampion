...
const alias = {
  ...
  '@platform/components.ravendb': path.resolve('./components/ravendb/index.ts'),
  '@platform/components.search': path.resolve('./components/search/index.ts'),
  ...
  '@platform/integrations.cloudflare': path.resolve('./integrations/cloudflare/index.ts'),
}
